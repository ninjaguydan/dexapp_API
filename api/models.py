...
class Type(models.Model):
	...
	pkmn = models.ManyToManyField('api.Pokemon', related_name = "types")
...
class Pokemon(models.Model):
	...
	weak_to = models.ManyToManyField('api.Type', related_name = "weak_pkmn")
	resists = models.ManyToManyField('api.Type', related_name = "resistant_pkmn")
	immune_to = models.ManyToManyField('api.Type', related_name = "immune_pkmn")
	objects = PokeManager()
